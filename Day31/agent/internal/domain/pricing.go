...
var KnownPrices = map[string]ModelPrice{
	...
	// GigaChat (Sber) — pricing is in RUB, cost tracking disabled (0/0).
	// Context windows from the official model docs.
	"GigaChat":     {0, 0, 8_192},
	"GigaChat-Pro": {0, 0, 8_192},
	"GigaChat-Max": {0, 0, 8_192},
	"GigaChat-2":       {0, 0, 32_768},
	"GigaChat-2-Pro":   {0, 0, 32_768},
	"GigaChat-2-Max":   {0, 0, 128_000},
}
